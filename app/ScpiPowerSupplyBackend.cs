...
{
    internal sealed class ScpiPowerSupplyBackend : IPowerSupplyBackend
    {
        private readonly ScpiPowerSupply inner;
        private ActiveStateHandler? activeStateEvent;
        private DisconnectedHandler? disconnectedEvent;

        public ScpiPowerSupplyBackend(ScpiPowerSupply inner)
        {
            this.inner = inner;
        }
